...
class overview {
	...
	/**
	 * HTML-Template für Einträge einzelner Kurse in Kurslisten, die Variablen einfach durch Werte ersetzen
	 ...
	 * @var #modified# Zeit der letzten Kurs-Änderung
			...
			<div class="row #MoodleTUCaN#">
				<div class="col-md-8">
					...
					<div class="row">
	            		...
	            		<div class="col-md-6">Geändert am #modified#</div>
					</div>
				</div>
				<div class="col-md-4">
